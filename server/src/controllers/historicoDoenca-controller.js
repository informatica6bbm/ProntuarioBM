...
const HistoricoDoenca = require('./../models/HistoricoDoenca');
const Pessoa = require('./../models/Pessoa');

exports.get = (req, res, next) => {
    const id = req.params.id;
    HistoricoDoenca.findAll().then(response => {
        var find = [];
...
exports.post = (req, res, next) => {
    ...
    HistoricoDoenca.create(data).then(response => {
