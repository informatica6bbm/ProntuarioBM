...
<script>
    import NovaPessoaHistoricoDoencas from '@/components/material/NovaPessoaHistoricoDoencas';
    import EditarPessoaHistoricoDoencas from '@/components/material/EditarPessoaHistoricoDoencas';
    import DoencasHistorico from '@/components/material/DoencasHistorico';

    export default {
        components: {
            'nova-pessoa-historico-doencas': NovaPessoaHistoricoDoencas,
            'editar-pessoa-historico-doencas': EditarPessoaHistoricoDoencas,
            'doencas-historico': DoencasHistorico
        },
        data: () => ({
            busca: "",
            desserts: [],
        ...
        methods: {
            initialize () {
                this.axios.get(process.env.VUE_APP_URL_API + '/historicoDoenca').then(response => {
            ...
            deleteItem(item){
                this.axios.delete(process.env.VUE_APP_URL_API + '/historicoDoenca/' + item.id + '/delete').then(response => {
                    if(response.data){
                        this.initialize();
                    }
                });
