                                            ...
                                            <v-row>
                                                <v-col cols="12" sm="12" md="6">
                                                    <v-text-field
                                                        ...
                                                        :rules="[v => !!v || 'Obrigatório prencher o medicamento!']"
                                                        label="Medicamento"
                                                        outlined
                                                    ></v-text-field>
                                                </v-col>
                                                ...
                                                <v-col cols="12" sm="12" md="6">
                                                    <v-select
                                                        ...
                                                        :rules="[v => !!v || 'Obrigatório prencher o tipo do medicamento!']"
...
<script>
    export default {
        data: () => ({
            ...
            editedIndex: -1,
            editedItem: {
                idUSuarioMedicamentoControlado: null,
                medicamento: "",
                tipo: "",
                createdAt: "",
                updatedAt: ""
        ...
        methods: {
            initialize () {
                this.axios.get(process.env.VUE_APP_URL_API + '/medicamentoControlado/' + this.idHistorico).then(response => {
            ...
            deleteItem (item) {
                this.axios.delete(process.env.VUE_APP_URL_API + '/medicamentoControlado/' + item.id + "/delete").then(response => {
                    if(response.data){
                        this.snackbar = true;
                        this.color = 'success';
            ...
            save() {
                this.editedItem.idUSuarioMedicamentoControlado = this.idHistorico;
                console.log(this.editedItem);
                this.axios.post(process.env.VUE_APP_URL_API + '/medicamentoControlado', this.editedItem).then(response => {
                    if(response.data) {
