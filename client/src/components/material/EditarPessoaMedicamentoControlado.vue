<template>
    <v-dialog v-model="dialog" max-width="500px">
        <v-card>
            <v-card-title>
                <span class="headline">Editar Pessoa Medicamento controlado</span>
            </v-card-title>
    ...
    export default {
        ...
        methods: {
            ...
            salvar() {
                ...
                this.axios.put(process.env.VUE_APP_URL_API + '/usuarioMedicamentoControlado', data).then(response => {
